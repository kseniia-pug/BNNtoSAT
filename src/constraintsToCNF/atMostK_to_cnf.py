...
path_cnf = "../../data/CNFs/equal_models_0_and_5_atMostK.cnf"
path_res_cnf = "../../data/CNFs/equal_models_0_and_5_cnf.cnf"
...
def atMostK_to_cnf(path_cnf, path_res_cnf):
    ...
    with open(path_res_cnf, 'r+') as fp: # Там есть ограничение на длину списка в 536 870 912, так что поаккуратнее с большими формулами
        lines = fp.readlines()
